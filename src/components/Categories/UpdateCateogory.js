...
import { deleteCategoriesAction,updateCategoriesAction, fetchDetailCategoriesAction } from "../../redux/slices/category/categorySlices";
...
const UpdateCategory = () => {
  ...
  //fetch Single
  useEffect(()=>{
    dispatch(fetchDetailCategoriesAction(id))
  },[])
  // get data from store
  ...
  if(isEdited || isDeleted) return <Navigate to="/category-list" replace/>
  return (
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            {/* Display err */}
            <div>
              {appErr || serverErr ? <h2 className="text-red-500 text-center text-lg">
                {appErr} {serverErr}
              </h2> : null}
            </div>
          </p>
