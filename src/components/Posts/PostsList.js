...
import { fetchPostAction } from "../../redux/slices/posts/PostsSlices";
          ...
          <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap -mx-3">
              ...
              <div class="w-full lg:w-3/4 px-3">
                  {/* post guest here */}
                  {loading ? <h1>Loading...</h1> : appErr || serverErr ? <h1>Err</h1>: postLists?.lenght <= 0 ? <h1>No Post Found</h1> : postLists?.map((post)=>(
                    ...
                    <div className="flex flex-row bg-gray-300 justify-center w-full  items-center ">
                      ...
                      <div className="flex flex-row justify-center items-center ml-4 mr-4 pb-2 pt-1">
                        ...
                        <div className="pl-2 text-gray-600">
                          {/* {post?.numViews} */} {post?.numViews?.lenght ? post?.numViews?.lenght : 0}
                        </div>
                      </div>
                    </div>
                  </div>
