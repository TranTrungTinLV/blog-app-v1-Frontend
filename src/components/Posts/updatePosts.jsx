...
import { fetchPostDetailsAction, updatePostAction } from "../../redux/slices/posts/PostsSlices";
            ...
            <div className="min-h-screen bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-300">
                        ...
                        <p>
                            <span className="text-green-600">{postDetails?.title}</span>
                        </p>
                    </h2>
                    {appErr || serverErr ? <h1 className="text-red-500 text-center text-xl">{serverErr} {appErr}</h1> : null}
                </div>
